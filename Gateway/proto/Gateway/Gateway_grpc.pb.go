...
const (
	GatewayService_CrearPedido_FullMethodName     = "/Gateway.GatewayService/CrearPedido"
	GatewayService_ConsultarEstado_FullMethodName = "/Gateway.GatewayService/ConsultarEstado"
)
